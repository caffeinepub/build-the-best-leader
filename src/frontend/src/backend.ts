...
export class Backend implements backendInterface {
    ...
    async getLeaderboard(): Promise<Array<TeamEntry>> {
    ...
    async submitEntry(arg0: string, arg1: Array<string>, arg2: bigint): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.submitEntry(arg0, arg1, arg2);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
